...
*/
		...
		/// <summary>
		/// Returns an array of all the X values on the plot.
		/// </summary>
		public double[] X {
			get {
				double[] ret = new double[this.Count];
				for (int i = 0; i < this.Count; i++) ret[i] = this[i].X;
				return ret;
			}
			set { SetX(value); }
		}
		...
		/// <summary>
		/// Returns an array of all the Y values on the plot.
		/// </summary>
		public double[] Y {
			get {
				double[] ret = new double[this.Count];
				for (int i = 0; i < this.Count; i++) ret[i] = this[i].Y;
				return ret;
			}
			set { SetY(value); }
		}
		...
		/// <summary>
		/// Returns an array of all the Z values on the plot.
		/// </summary>
		public double[] Z {
			get {
				double[] ret = new double[this.Count];
				for (int i = 0; i < this.Count; i++) ret[i] = this[i].Z;
				return ret;
			}
			set { SetZ(value); }
		}
		...
		/// <summary>
		/// Returns the average of all the X values on the plot.
		/// </summary>
		public double meanX {
			get {
				double ret = 0;
				for (int i = 0; i < this.Count; i++) ret += this[i].X;
				return ret / this.Count;
			}
		}

		/// <summary>
		/// Returns the average of all the Y values on the plot.
		/// </summary>
		public double meanY {
			get {
				double ret = 0;
				for (int i = 0; i < this.Count; i++) ret += this[i].Y;
				return ret / this.Count;
			}
		}

		/// <summary>
		/// Returns the average of all the Z values on the plot.
		/// </summary>
		public double meanZ {
			get {
				double ret = 0;
				for (int i = 0; i < this.Count; i++) ret += this[i].Z;
				return ret / this.Count;
			}
		}
	#endregion
